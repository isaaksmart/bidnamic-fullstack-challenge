...
class Bidnamic(models.Model):
    ...
    Title = models.CharField(max_length=3, choices=TITLE_CHOICES, default=TITLE_CHOICES[0])
    ...
    BiddingSettings = models.CharField(max_length=100, verbose_name=u"Bidding Settings", choices=BID_CHOICES,  default=BID_CHOICES[0])
